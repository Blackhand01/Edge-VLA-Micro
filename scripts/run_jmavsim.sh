...
export PATH="/opt/homebrew/opt/openjdk@17/bin:${PX4_DIR}/build/px4_sitl_default/bin:/opt/homebrew/opt/arm-gcc-bin@13/bin:/opt/homebrew/opt/ccache/libexec:${PATH}"
